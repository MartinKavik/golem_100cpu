...
macro_rules! __export_cpu100_impl {
...
#[doc(inline)]
pub(crate) use __export_cpu100_impl as export;

#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.25.0:cpu100:encoded world"]
#[doc(hidden)]
...
\x16golem:component/cpu100\x04\0\x0b\x0c\x01\0\x06cpu100\x03\0\0\0G\x09producers\
